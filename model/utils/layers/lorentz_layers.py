...
class LorentzLinear(nn.Module):
    ...
    def __init__(self, manifold:CustomLorentz, in_features, out_features, c, drop_out, use_bias):
...
class LorentzAgg(Module):
    ...
    """
    def __init__(self, manifold:CustomLorentz, c, use_att, in_features, dropout):
    ...
    def lorentz_centroid(self, weight, x, c):
        ...
        x_inner = self.manifold.inner(sum_x, sum_x)
...
class LorentzAct(Module):
    ...
    """
    def __init__(self, manifold:CustomLorentz, c_in, c_out, act):
